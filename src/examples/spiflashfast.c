/*
 * Example code of using the low-latency FastRead and FastWrite functions (SPI
 * and C only). Contrast to spiflash.c.
 */
...
#define RCMD                                                                   \
    "\x03\x00\x00\x00"   // Standard SPI flash read command (0x03) followed by
